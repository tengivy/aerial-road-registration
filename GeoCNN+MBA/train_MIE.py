...
Validation = True
BATCH_SIZE = 32
LEARNING_RATE = 1e-4 #restore 160000 #5e-4 #1e-6 #5e-4 #5e-4 #1e-3 
Decay_steps = 10000 #restore 160000 #10000 #10000 #10000 #10000 #10000
Decay_rate = 0.96 #restore 160000 #0.96 #0.96 #0.96 #0.94 # 0.90
MAX_STEPS = 1000000
MAX_VAL = 95   # 3049/batchsize
EPOCH = 1226  # 39236/batchsize

DATA_DIR = 'DATASET_TRAIN_30_60_FR_AU/'
VAL_DIR = 'DATASET_VAL_30_60_FR_AU/'
CHECKPOINT_DIR = 'MIE_checkpoints_30_60/'
IMAGE_WIDTH = 256
IMAGE_HEIGHT = 256
INPUT_WIDTH = 400
INPUT_HEIGHT = 400
...
def main(_):
    ...
    writer = tf.summary.FileWriter('MIE_logs/train', sess.graph)
    writer_val = tf.summary.FileWriter('MIE_logs/validation')
